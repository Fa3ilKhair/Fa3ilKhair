...
export default function StatictPart(){
    ...
    return(
             <div className="bg-[#F5F7FA] phone:flex-col flex justify-evenly py-20  phone:gap-10 phone:py-15 " >
            ...
            <div className="flex flex-wrap gap-8 phone:justify-end  ">
                <Statistic icon={faUserGroup} number={"2341"} subject={"Members"}/>
                <Statistic icon={faHandsHolding} number={"39328"} subject={"béneficiares"}/>
                <Statistic icon={faCheck} number={"829"} subject={"Projets réalisés"}/>
                <Statistic icon={faCoins} number={"926536"} subject={"Dhs recus"}/>
            </div>
        </div>
    );
}